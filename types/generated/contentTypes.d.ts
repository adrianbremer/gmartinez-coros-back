...
export interface ApiLiturgicalSeasonLiturgicalSeason
  extends Struct.CollectionTypeSchema {
...
export interface ApiLiturgicalSectionLiturgicalSection
  extends Struct.CollectionTypeSchema {
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    last_name_2: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
      }>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSongSong extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::song.song'> &
      Schema.Attribute.Private;
    lyrics_file: Schema.Attribute.Media<'files'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
...
export interface ApiVestmentVestment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    occasion: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
